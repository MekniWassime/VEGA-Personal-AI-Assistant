...
const systemBasePrompt = `
	...
	If you are abseloutly sure that the task was complete, respond only with "TASK_COMPLETE", if you intend this message to be the last, append "TASK_COMPLETE" to the strict end of the message
